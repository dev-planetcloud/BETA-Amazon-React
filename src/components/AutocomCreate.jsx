...
function AutocomCreate({onProvinceChange}) {
  ...
  return (
    <>
      {/* <Autocomplete
        options={provinces.map((province) => province.provinceNameTh)}
        renderInput={(params) => (
          <TextField {...params} />
        )}
        ...
        <Autocomplete
          ...
          renderInput={(params) => (
            <div ref={params.InputProps.ref}>
              <input type="text" {...params.inputProps} className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[4px] focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"/>
            </div>
          )}
          onChange={handleProvinceChange}
