        ...
        <Autocomplete
          ...
          renderInput={(params) => (
            <div ref={params.InputProps.ref}>
              <input  type="text" {...params.inputProps} className=" w-full px-4 py-2 mt-2 text-cyan-600 md:w-full lg:w-90 bg-gray-50 border rounded-md border-[#1ab6c1]  focus:ring-cyan-300 focus:outline-none focus:ring-2 "/>
            </div>
          )}
          onChange={handleProvinceChange}
